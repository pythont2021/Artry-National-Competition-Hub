  ...
  if (!isEnrolled) {
    return (
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
            <h1 className="font-headline text-4xl font-bold">Welcome, {artistUser.name.split(' ')[0]}!</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            <div className="md:col-span-1">
                 <ProfileCard 
                    ...
                    description={artistUser.description}
                    details={artistUser.details}
                />
            </div>
            <div className="md:col-span-2">
                <EnrollmentCard userCategory={artistUser.category} />
            </div>
        </div>
      </div>
    );
